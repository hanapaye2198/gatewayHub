<x-layouts::app :title="__('Dashboard')">
    <div class="flex h-full w-full flex-1 flex-col gap-8">
        <div>
            ...
            <p class="mt-1 text-zinc-600 dark:text-zinc-400">{{ __('Welcome to your merchant dashboard. Use the sidebar to view payments, manage API credentials, and configure gateways.') }}</p>
        </div>
            ...
            <div class="rounded-xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
                <div class="flex items-start justify-between">
                    <div class="min-w-0 flex-1">
                        ...
                        <p class="mt-2 text-lg font-medium text-zinc-900 dark:text-zinc-100">{{ __('Configure payment gateways') }}</p>
                        <p class="mt-1 text-xs text-zinc-400 dark:text-zinc-500">{{ __('Use the sidebar to navigate') }}</p>
                    </div>
                    <div class="ml-4 flex size-10 shrink-0 items-center justify-center rounded-lg bg-zinc-100 dark:bg-zinc-700/50">
