...
class ValidateProductionEnvironmentTest extends TestCase
{
    ...
    public function test_it_fails_when_app_url_uses_localhost_in_production(): void
    {
        ...
        $this->expectException(RuntimeException::class);
        $this->expectExceptionMessage('APP_URL must be a public HTTP(S) URL in production');
